...
d = gendhard(n = n, p = p, active = active, randomCoef = F)
true = c(rep(1, active), rep(0,p-active))
S1.10hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))

# Simulation 1: SNR = 5
set.seed(1)
n = 20; p = 1000; active = 2; repeats = 1000; snr = 5
true = c(rep(1, active), rep(0,p - active))
S1.5hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))

# Simulation 1: SNR = 3
set.seed(1)
n = 20; p = 1000; active = 2; repeats = 1000;  snr = 3
true = c(rep(1, active), rep(0,p - active ))
S1.3hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))

# Simulation 1: SNR = 1
set.seed(1)
n = 20; p = 1000; active = 2; repeats = 1000; snr = 1
true = c(rep(1, active), rep(0,p - active ))
S1.1hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))
...
true = c(rep(1, active), rep(0,p - active ))
d = gendhard(n = n, p = p, active = active, randomCoef = F)
S2.10hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))

# Simulation 4: SNR = 5
set.seed(1)
n = 100; p = 500; active = 10; repeats = 1000; snr = 5
true = c(rep(1, active), rep(0,p - active ))
S2.5hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))

# Simulation 4: SNR = 3
set.seed(1)
n = 100; p = 500; active = 10; repeats = 1000; snr = 3
true = c(rep(1, active), rep(0,p - active ))
S2.3hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))

# Simulation 4: SNR = 1
set.seed(1)
n = 100; p = 500; active = 10; repeats = 1000; snr = 1
true = c(rep(1, active), rep(0,p - active ))
S2.1hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))
...
true = c(rep(1, active), rep(0,p - active ))
d = gendhard(n = n, p = p, active = active, randomCoef = F)
S3.10hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))

# Simulation 2: SNR = 5
set.seed(1)
n = 200; p = 200; active = 20; repeats = 1000;  snr = 5
true = c(rep(1, active), rep(0,p - active))
S3.5hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))

# Simulation 2: SNR = 3
set.seed(1)
n = 200; p = 200; active = 20; repeats = 1000;  snr = 3
true = c(rep(1, active), rep(0,p - active ))
S3.3hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))

# Simulation 2: SNR = 1
set.seed(1)
n = 200; p = 200; active = 20; repeats = 1000; snr = 1
true = c(rep(1, active), rep(0,p - active ))
S3.1hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))
...
true = c(rep(1, active), rep(0,p - active ))
d = gendhard(n = n, p = p, active = active, randomCoef = F)
S4.10hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))

# Simulation 3: SNR = 5
set.seed(1)
n = 500; p = 100; active = 20; repeats = 1000; snr = 5
true = c(rep(1, active), rep(0,p - active ))
S4.5hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))

# Simulation 3: SNR = 3
set.seed(1)
n = 500; p = 100; active = 20; repeats = 1000; snr = 3
true = c(rep(1, active), rep(0,p - active ))
S4.3hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))

# Simulation 3: SNR = 1
set.seed(1)
n = 500; p = 100; active = 20; repeats = 1000; snr = 1
true = c(rep(1, active), rep(0,p - active ))
S4.1hard = replicate(repeats, qlocNew(d = d, true = true, p = p, snr = snr))
